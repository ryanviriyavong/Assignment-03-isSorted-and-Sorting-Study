 ...
 * Course: CS 210 - Data Structures / Algorithms
 * Assignment: Assignment 03 - isSorted and Sorting Study
 * File Name: Viriyavong_Ryan_Assignment03.cpp
 * Author: Ryan Viriyavong
 * Date: 9/20/2026
 * 
 * AI Tool Used: Gemini
 * Nature of AI Assistance:
 *   - Assisted with designing C++ benchmarking and timing framework using <chrono>.
 *   - Helped structure partition logic and median pivot selection for Quick Sort.
 * 
 * ============================================================================
 */
